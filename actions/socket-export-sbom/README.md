...
jobs:
  export-sbom:
    ...
    steps:
      - name: Checkout
        uses: actions/checkout@8e8c483db84b4bee98b60c0593521ed34d9990e8 # v0.2.0

      - name: Get vault secrets
        id: vault-secrets
        uses: grafana/shared-workflows/actions/get-vault-secrets@get-vault-secrets/v0.2.0
        with:
          repo_secrets: |
      ...
      - name: Export SBOM from Socket
        id: export-sbom
        uses: grafana/shared-workflows/actions/socket-export-sbom@socket-export-sbom/v0.2.0
        with:
          socket_api_token: ${{ fromJSON(steps.vault-secrets.outputs.secrets).SOCKET_API_TOKEN }}
          output_file: ${{ inputs.output_file }}

      - name: Upload SBOM artifact
        uses: actions/upload-artifact@330a01c490aca151604b8cf639adc76d48f6c5d4 # v0.2.0
        with:
          name: "sbom"
